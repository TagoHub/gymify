...
exercise_1 = exercise_group_1.exercises.create!(name: "Incline Bench Press",        exercise_type: "Compound",  rep_range_min: 6,  rep_range_max: 8,  unit: unit_5, rest_time: 180, unilateral: false, instrument: instrument_1, notes: "Include myoreps for final set")
exercise_2 = exercise_group_2.exercises.create!(name: "Dumbell Row",                exercise_type: "Compound",  rep_range_min: 8,  rep_range_max: 10, unit: unit_5, rest_time: 180, unilateral: true,  instrument: instrument_5, notes: "")
exercise_3 = exercise_group_3.exercises.create!(name: "Dumbell Lateral Raise",      exercise_type: "Isolation", rep_range_min: 12, rep_range_max: 15, unit: unit_5, rest_time: 30,  unilateral: false, instrument: instrument_5, notes: "Superset 1")
exercise_4 = exercise_group_3.exercises.create!(name: "Lat Pulldown",               exercise_type: "Compound",  rep_range_min: 8,  rep_range_max: 10, unit: unit_5, rest_time: 30,  unilateral: false, instrument: instrument_3, notes: "Superset 1")
exercise_5 = exercise_group_4.exercises.create!(name: "Dumbell Fly",                exercise_type: "Isolation", rep_range_min: 15, rep_range_max: 20, unit: unit_5, rest_time: 120, unilateral: false, instrument: instrument_5, notes: "")
exercise_6 = exercise_group_5.exercises.create!(name: "EZ-Bar Biceps Curl",         exercise_type: "Isolation", rep_range_min: 12, rep_range_max: 15, unit: unit_5, rest_time: 30,  unilateral: false, instrument: instrument_2, notes: "Superset 2")
exercise_7 = exercise_group_5.exercises.create!(name: "Overhead Tricep Extensions", exercise_type: "Isolation", rep_range_min: 12, rep_range_max: 15, unit: unit_5, rest_time: 30,  unilateral: false, instrument: instrument_3, notes: "Superset 2")
...
set_1 = exercise_1.exercise_sets.create!(order: 1, set_type: "Warmup Set",  reps: 10, load: 0,  unit: unit_2)
set_2 = exercise_1.exercise_sets.create!(order: 2, set_type: "Warmup Set",  reps: 5,  load: 15, unit: unit_2)
set_3 = exercise_1.exercise_sets.create!(order: 3, set_type: "Warmup Set",  reps: 3,  load: 40, unit: unit_2)
set_4 = exercise_1.exercise_sets.create!(order: 4, set_type: "Working Set", reps: 4,  load: 55, unit: unit_2, intensity: 7)
set_5 = exercise_1.exercise_sets.create!(order: 5, set_type: "Working Set", reps: 4,  load: 55, unit: unit_2, intensity: 8, intensity_technique: intensity_technique_3)
puts "Sets created for Incline Bench Press: #{set_1.set_type}, #{set_2.set_type}, #{set_3.set_type}, #{set_4.set_type}, #{set_5.set_type}\n"

set_6 = exercise_2.exercise_sets.create!(order:  1, set_type: "Warmup Set",  reps: 5,  load: 10,   unit: unit_1)
set_7 = exercise_2.exercise_sets.create!(order:  2, set_type: "Warmup Set",  reps: 3,  load: 13.5, unit: unit_1)
set_8 = exercise_2.exercise_sets.create!(order:  3, set_type: "Working Set", reps: 10, load: 18,   unit: unit_1, intensity: 7)
set_9 = exercise_2.exercise_sets.create!(order:  4, set_type: "Working Set", reps: 10, load: 18,   unit: unit_1, intensity: 7)
set_10 = exercise_2.exercise_sets.create!(order: 5, set_type: "Working Set", reps: 12, load: 18,   unit: unit_1, intensity: 9)
