...
puts "Grips created: #{grip_1.name}, #{grip_2.name}, #{grip_3.name}, #{grip_4.name}, #{grip_5.name}, #{grip_6.name}, #{grip_7.name}\n"
...
user_1 = User.first_or_create!("name": "Santiago Morales", "email": "tago470@gmail.com", "password": "12345678", "gender": "Male", "weight": 75, "weight_unit": "kg", "height": 185, "height_unit": "cm")
puts "User created: #{user_1.name} (#{user_1.email})\n"

program_1 = user_1.programs.create!("name": "UPPER/LOWER SPLIT 4X/WEEK", "frequency": 4, "level": "All levels", "goal": "Time-limited muscle and strength", "minutes_min": 45, "minutes_max": 60)
...
exercise_1 = exercise_group_1.exercises.create!("name": "Incline Bench Press", "notes": "Include myoreps for final set", "exercise_type": "Compound", "rep_range_min": 6, "rep_range_max": 8, "rest_seconds": 180, "unilateral": false, instrument: instrument_1)
exercise_2 = exercise_group_2.exercises.create!("name": "Dumbell Row", "notes": "", "exercise_type": "Compound", "rep_range_min": 8, "rep_range_max": 10, "rest_seconds": 180, "unilateral": true, instrument: instrument_5)
exercise_3 = exercise_group_3.exercises.create!("name": "Dumbell Lateral Raise", "notes": "Superset 1", "exercise_type": "Isolation", "rep_range_min": 12, "rep_range_max": 15, "rest_seconds": 30, "unilateral": false, instrument: instrument_5)
exercise_4 = exercise_group_3.exercises.create!("name": "Lat Pulldown", "notes": "Superset 1", "exercise_type": "Compound", "rep_range_min": 8, "rep_range_max": 10, "rest_seconds": 30, "unilateral": false, instrument: instrument_3)
exercise_5 = exercise_group_4.exercises.create!("name": "Dumbell Fly", "notes": "", "exercise_type": "Isolation", "rep_range_min": 15, "rep_range_max": 20, "rest_seconds": 120, "unilateral": false, instrument: instrument_5)
exercise_6 = exercise_group_5.exercises.create!("name": "EZ-Bar Biceps Curl", "notes": "Superset 2", "exercise_type": "Isolation", "rep_range_min": 12, "rep_range_max": 15, "rest_seconds": 30, "unilateral": false, instrument: instrument_2)
exercise_7 = exercise_group_5.exercises.create!("name": "Overhead Tricep Extensions", "notes": "Superset 2", "exercise_type": "Isolation", "rep_range_min": 12, "rep_range_max": 15, "rest_seconds": 30, "unilateral": false, instrument: instrument_3)
...
set_1 = exercise_1.exercise_sets.create!("set_type": "Warmup Set", "reps": 10, "load": 0, "unit": "lb", "intensity": nil)
set_2 = exercise_1.exercise_sets.create!("set_type": "Warmup Set", "reps": 5, "load": 15, "unit": "lb", "intensity": nil)
set_3 = exercise_1.exercise_sets.create!("set_type": "Warmup Set", "reps": 3, "load": 40, "unit": "lb", "intensity": nil)
set_4 = exercise_1.exercise_sets.create!("set_type": "Working Set", "reps": 4, "load": 55, "unit": "lb", "intensity": 7)
set_5 = exercise_1.exercise_sets.create!("set_type": "Working Set", "reps": 4, "load": 55, "unit": "lb", "intensity": 8, "intensity_technique": intensity_technique_3)
puts "Sets created for Incline Bench Press: #{set_1.set_type}, #{set_2.set_type}, #{set_3.set_type}, #{set_4.set_type}, #{set_5.set_type}\n"

set_6 = exercise_2.exercise_sets.create!("set_type": "Warmup Set", "reps": 5, "load": 10, "unit": "kg", "intensity": nil)
set_7 = exercise_2.exercise_sets.create!("set_type": "Warmup Set", "reps": 3, "load": 13.5, "unit": "kg", "intensity": nil)
set_8 = exercise_2.exercise_sets.create!("set_type": "Working Set", "reps": 10, "load": 18, "unit": "kg", "intensity": 7)
set_9 = exercise_2.exercise_sets.create!("set_type": "Working Set", "reps": 10, "load": 18, "unit": "kg", "intensity": 7)
set_10 = exercise_2.exercise_sets.create!("set_type": "Working Set", "reps": 12, "load": 18, "unit": "kg", "intensity": 9)
