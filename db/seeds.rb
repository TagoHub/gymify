...
unit_1 = Unit.create!(name: "Kilograms", abbreviation: "Kgs", unit_type: "Weigth")
unit_2 = Unit.create!(name: "Pounds", abbreviation: "Lbs", unit_type: "Weigth")
...
instrument_8 = Instrument.create!(name: "Free Weigth", weight: 0, unit: unit_1, grip: grip_2)
